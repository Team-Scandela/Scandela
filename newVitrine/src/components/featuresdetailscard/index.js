...
const FeaturesCardsDetail = () => {
    return (
        <FeaturesCardsDetailContainer>
            ...
            <Card title="Indicateurs d'états" text="Visualisez les indicateurs d'états de votre parc d'éclairage public pour une meilleure compréhension globale" icon={<LuGaugeCircle color={Green}/>} />
            <Card title="Bilan économique" text="Accèdez aux coûts à courts termes et gains à longs termes des actions choisies par vos soins." icon={<CiBadgeDollar color={Yellow}/>} />
        </FeaturesCardsDetailContainer>
    );
}
