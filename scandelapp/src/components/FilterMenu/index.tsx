    ...
    return (
        <div id={id}>
            ...
            <FilterMenuContainer show={on} isDark={isDark}>
                <MdOutlinePlace
                    style={chooseStyle("pin")}
                    onClick={() => handleIconClick("pin")}
                />
                <MdDataUsage
                    style={chooseStyle("zone")}
                    onClick={() => handleIconClick("zone")}
                />
                <MdPlace
                    style={chooseStyle("pinColor")}
                    onClick={() => handleIconClick("pinColor")}
                />
                <MdFilterList
                    style={chooseStyle("filter")}
                    onClick={() => handleIconClick("filter")}
                />
                <MdDirectionsCar
                    style={chooseStyle("traffic")}
                    onClick={() => handleIconClick("traffic")}
                />
                <MdElectricMeter
                    style={chooseStyle("cabinet")}
                    onClick={() => handleIconClick("cabinet")}
                />
            </FilterMenuContainer>
        </div>
    );
