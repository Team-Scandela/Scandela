...
import { TutorielBackground, SkipTutoButtonContainer, CustomContainerInfoPopup, Arrow, TitleText, DefaultText } from './elements';
...
const Tutoriel: React.FC<TutorielProps> = ({
    ...
    const handleNextStep = () => {
        ...
        if (currentStep === 5)
            setFilterPanelExtended(true);
        else if (currentStep === 12)
            setFilterPanelExtended(false);
    ...
    return (
        <div>
            <TutorielBackground onClick={() => handleNextStep()}>
                ...
                {currentStep === 0 && ( // Intro
                    <div>
                        <CustomContainerInfoPopup isDark={isDark} top={"23%"} left={"36.5%"} height={"240px"} width={"450px"}>
                ...
                {currentStep === 1 && ( // Absence panel
                    <div>
                        <Arrow isDark={isDark} top={"11.5%"} left={"33.2%"}></Arrow>
                        <CustomContainerInfoPopup isDark={isDark} top={"13%"} left={"31.5%"} height={"140px"} width={"330px"}>
                ...
                {currentStep === 2 && ( // Search bar
                    <div>
                        <Arrow isDark={isDark} top={"11.5%"} left={"9%"}></Arrow>
                        <CustomContainerInfoPopup isDark={isDark} top={"13%"} left={"6%"} height={"140px"} width={"330px"}>
                ...
                {currentStep === 3 && ( // Search bar option
                    <div>
                        <Arrow isDark={isDark} top={"11.5%"} left={"26.5%"}></Arrow>
                        <CustomContainerInfoPopup isDark={isDark} top={"13%"} left={"23.5%"} height={"140px"} width={"330px"}>
                ...
                {currentStep === 4 && ( // Notifications history
                    <div>
                        <Arrow isDark={isDark} top={"11.8%"} left={"7.1%"}></Arrow>
                        <CustomContainerInfoPopup isDark={isDark} top={"10%"} left={"8%"} height={"140px"} width={"330px"}>
                ...
                {currentStep === 5 && ( // Actions history
                    <div>
                        <Arrow isDark={isDark} top={"18.8%"} left={"7.1%"}></Arrow>
                        <CustomContainerInfoPopup isDark={isDark} top={"17%"} left={"8%"} height={"150px"} width={"340px"}>
                ...
                {currentStep === 6 && ( // Filters
                    <div>
                        <Arrow isDark={isDark} top={"83%"} left={"2.3%"}></Arrow>
                        <CustomContainerInfoPopup isDark={isDark} top={"66%"} left={"1%"} height={"140px"} width={"330px"}>
                ...
                {currentStep === 7 && ( // Filters 1
                    <div>
                        <Arrow isDark={isDark} top={"83%"} left={"7.4%"}></Arrow>
                        <CustomContainerInfoPopup isDark={isDark} top={"66%"} left={"5.1%"} height={"140px"} width={"330px"}>
                ...
                {currentStep === 8 && ( // Filters 2
                    <div>
                        <Arrow isDark={isDark} top={"83%"} left={"10.2%"}></Arrow>
                        <CustomContainerInfoPopup isDark={isDark} top={"66%"} left={"7.9%"} height={"140px"} width={"330px"}>
                ...
                {currentStep === 9 && ( // Filters 3
                    <div>
                        <Arrow isDark={isDark} top={"83%"} left={"13.3%"}></Arrow>
                        <CustomContainerInfoPopup isDark={isDark} top={"65%"} left={"11%"} height={"150px"} width={"340px"}>
                ...
                {currentStep === 10 && ( // Filters 4
                    <div>
                        <Arrow isDark={isDark} top={"83%"} left={"16.2%"}></Arrow>
                        <CustomContainerInfoPopup isDark={isDark} top={"66%"} left={"13.9%"} height={"140px"} width={"330px"}>
                ...
                {currentStep === 11 && ( // Filters 5
                    <div>
                        <Arrow isDark={isDark} top={"83%"} left={"19.1%"}></Arrow>
                        <CustomContainerInfoPopup isDark={isDark} top={"65%"} left={"16.8%"} height={"150px"} width={"330px"}>
                ...
                {currentStep === 12 && ( // Filters 6
                    <div>
                        ...
                        <CustomContainerInfoPopup isDark={isDark} top={"66%"} left={"19.7%"} height={"140px"} width={"330px"}>
                ...
                {currentStep === 13 && ( // Indicators
                    <div>
                        ...
                        <CustomContainerInfoPopup isDark={isDark} top={"56%"} left={"74%"} height={"150px"} width={"380px"}>
                ...
                {currentStep === 14 && ( // Decision panel button
                    <div>
                        <Arrow isDark={isDark} top={"47.5%"} left={"90.5%"}></Arrow>
                        <CustomContainerInfoPopup isDark={isDark} top={"41%"} left={"70%"} height={"140px"} width={"330px"}>
                ...
                {currentStep === 16 && ( // Decision panel 2
                    <div>
                        <Arrow isDark={isDark} top={"31.5%"} left={"57.5%"}></Arrow>
                        <CustomContainerInfoPopup isDark={isDark} top={"25%"} left={"36.5%"} height={"150px"} width={"340px"}>
