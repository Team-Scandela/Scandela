        ...
        <ResetPwdPage>
            <ResetPwdContainer>
                <ResetPwdForm>
                    ...
                    <ResetPwdInput type="password" placeholder="New password" required onChange={(e : any) => setNewPassword(e.target.value)} />
                    <ResetPwdInput type="password" placeholder="Confirm new password" required onChange={(e : any) => setConfirmNewPassword(e.target.value)} />
                    <ResetPwdButton type="submit" onClick={submitNewPassword}>Reset</ResetPwdButton>
