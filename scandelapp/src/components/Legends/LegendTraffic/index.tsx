            ...
            {isModalOpen && (
                <S.Backdrop onClick={closeModal}>
                    <S.ModalWrapper onClick={stopPropagation}>
                        ...
                        <S.p>
                            Le filtre traffic ce compose de:
                            <br />- plusieurs lignes de traffic.
                            <br />- bleu clair signal un traffic peu dense.
                            <br />- bleu foncé signal un traffic assez dense.
                            <br />- rose/rouge signal que le traffic est très
                            dense que le passage est fréquent et donc important.
                            <br />- Ce filtre permet de mieux comprendre le
                            traffic dans sa ville.
                        </S.p>
