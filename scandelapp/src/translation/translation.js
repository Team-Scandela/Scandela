...
const resources = {
    en: {
        translation: {
            ...
            trafficFilterDescription: "The traffic filter consists of:<br>- Different colored lines to indicate the level of road usage.</br><br>- Blue lines for low usage.</br><br>- Pink lines for moderate usage.</br><br>- Red lines for high usage.</br>",
    ...
    fr: {
        translation: {
            ...
            trafficFilterDescription: "Le filtre de Traffic est composé de:<br>- Différentes lignes de couleurs pour indiquer le niveau d'utilisation d'une route.</br><br>- De lignes bleu quand peu utilisé.</br><br>- De lignes rose quand assez utilisé.</br><br>- De lignes rouge quand très utilisé.</br>	",
