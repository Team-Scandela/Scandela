...
const resources = {
    en: {
        translation: {
            ...
            faqTitle2: 'Why use the premium version of Scandela and what are its advantages?',
            faqTitle3: 'What are the advantages of using Scandela in my municipality?',
            faqTitle4: 'How does Scandela collect data on public lighting?',
            faqTitle5: 'What types of optimization recommendations are available in Scandela?',
            faqTitle6: 'Does Scandela offer specific recommendations based on the characteristics of my municipality?',
            faqTitle7: 'How can I interpret the optimizations provided by Scandela?',
            faqTitle8: 'Does Scandela consider environmental criteria in its recommendations?',
            faqTitle9: 'What is the frequency of updating the optimization recommendations?',
            faqTitle10: 'Does Scandela offer support in case of a problem or question?',
            faqTitle11: 'Does Scandela offer solutions for the transition to more sustainable lighting sources?',
            faqTitle12: 'What are the technical prerequisites for using Scandela?',
            faqTitle13: 'Does Scandela offer tracking and reporting features to evaluate the impact of optimizations?',
            faqTitle14: 'Are there costs associated with using Scandela?',
            faqTitle15: 'How is the privacy of user data protected?',
            faqTitle16: 'Is Scandela compatible with existing lighting management systems?',
            faqTitle17: 'How can I share the results and recommendations of Scandela with other stakeholders in the municipality?   ',
            faqDescription: 'Scandela is a web-based mapping software for decision-making in public lighting for French municipalities. Our goal is to help local authorities make the right decisions at the right time to manage their streetlights and other lights. We aim to reduce energy and environmental costs associated with public lighting while ensuring the safety of road users. Our solution will enable us to define which street/neighborhood needs to be lit at a given time thanks to multiple parameters. These parameters can be related to safety, biodiversity, traffic, etc. Our web project will be presented via a dashboard and several maps showing different information that will enable the stakeholders to make the right decisions.',
            name: 'Name',
            email: 'Email',
            password: 'Password',
            KWhOfTheCity: 'KWh of the city',
            WhileYouWereAway: 'While you were away',
            placeholderWhileYouWereAway: 'Malfunction of streetlight 86 Rue Henri IV',
            ...
            delete: 'Delete',
            priceLimitDescription: 'You have the option to set a high or low price limit to be notified by email when the price of electricity exceeds this threshold.',
            loading: 'loading ...',
    ...
    fr: {
        translation: {
            ...
            faqTitle2: 'Pourquoi utiliser la version premium de Scandela et quels sont ses avantages ?',
            faqTitle3: 'Quels sont les avantages d\'utiliser Scandela dans ma commune ?',
            faqTitle4: 'Comment Scandela collecte-t-elle les données sur l\'éclairage public ?',
            faqTitle5: 'Quels types de conseils d\'optimisation sont disponibles dans Scandela ?',
            faqTitle6: 'Est-ce que Scandela propose des recommandations spécifiques en fonction des caractéristiques de ma commune ?',
            faqTitle7: 'Comment puis-je interpréter les optimisations fournies par Scandela ?',
            faqTitle8: 'Est-ce que Scandela prend en compte des critères environnementaux dans ses recommandations ?',
            faqTitle9: 'Quelle est la fréquence de mise à jour des conseils d\'optimisation ?',
            faqTitle10: 'Est-ce que Scandela offre un support en cas de problème ou de question ?',
            faqTitle11: 'Est-ce que Scandela propose des solutions pour la transition vers des sources d\'éclairage plus durables ?',
            faqTitle12: 'Quels sont les prérequis techniques pour utiliser Scandela ?',
            faqTitle13: 'Scandela propose-t-elle des fonctionnalités de suivi et de rapport pour évaluer l\'impact des optimisations ?',
            faqTitle14: 'Y a-t-il des coûts associés à l\'utilisation de Scandela ?',
            faqTitle15: 'Comment la vie privée des données des utilisateurs est-elle protégée ?',
            faqTitle16: 'Est-ce que Scandela est compatible avec d\'autres systèmes de gestion de l\'éclairage existants ?',
            faqTitle17: 'Comment puis-je partager les résultats et les recommandations de Scandela avec d\'autres parties prenantes de la commune ?',
            faqDescription: 'Scandela est un logiciel web cartographique d’aide à la décision pour l’éclairage public des communes françaises. Notre but est d’aider les collectivités locales à prendre les bonnes décisions au bon moment pour gérer leur lampadaire et autres lumières. Nous avons pour objectif de diminuer les dépenses énergétiques et environnementales qui sont liés à l’éclairage public tout en assurant la sécurité des usagers sur les routes. Notre solution permettra de définir quel rue/quartier a besoin d\'être allumé de telle à telle heure grâce à  de multiples paramètres. Ces paramètres peuvent être liés à la sécurité, à la biodiversité, au trafic ... Notre projet web se présentera via un tableau de bord et plusieurs cartographies montrant différentes informations qui permettront aux acteurs concernés de prendre les bonnes décisions.',
            name: 'Nom',
            email: 'Email',
            password: 'Mot de passe',
            KWhOfTheCity: 'Kw/h de la ville',
            WhileYouWereAway: 'Pendant votre absence',
            placeholderWhileYouWereAway: 'Dérèglement du lampadaire 86 Rue Henri IV',
            ...
            OfTheAreasHaveGoodLighting: 'des zones disposent d\'un bon éclairage',
            createaPriceLimit: 'Créer une limite de prix',
            delete: 'Supprimer',
            priceLimitDescription: 'Vous avez la possibilité de renseigner une limite de prix haute ou basse afin d\'être notifié par mail quand le prix de l\'électricité dépassera ce seuil.',
            loading: 'Chargement ...',
