...
const resources = {
    en: {
        translation: {
            ...
            filterLegendHeader: "Electrical Cabinet Filter Legend",
            filterDescription: "The electrical cabinet filter consists of:<br />- Cabinets represented by a yellow lightning bolt.<br />- Are clickable and redirect you to the cabinet's park.<br />- Allow understanding of the management park of an electrical cabinet.",
            yellowLightningExplanation: "Yellow lightning: Lightning indicating the electrical cabinets.",
            blueLightningExplanation: "Blue lightning: Lightning indicating selected electrical cabinets.",
            bluePinExplanation: "Blue pin: Point indicating the streetlights linked to the electrical cabinets.",
            filter2LegendHeader: "Black Grid Filter Legend",
            filter2Description: "The black grid filter consists of:<br>- Various colored areas sensitive to ecology.</br><br>- The areas are clickable and display information about the zone.</br>",
            popup2Description: "Pop-Up: Description of the ecological zone.",
            heatmapLegendHeader: "Heatmap Filter Legend",
            heatmapDescription: "The heatmap filter consists of:<br>- Different zones with varying light concentration levels.</br><br>- Blue for areas with low brightness.</br><br>- Green for areas with medium brightness.</br><br>- Red for areas with high brightness.</br><br>- This information helps to view the light pollution status in certain areas.</br>",
            heatmapCircleExplanation: "Heatmap: Color index of the zone.",
            pinFilterLegendHeader: "Lamp Post Filter Legend",
            pinFilterDescription: "The lamp post filter consists of:<br>- Clusters displaying the number of lamp posts by zones based on zoom.</br><br>- Yellow points for each lamp post at the exact location.</br><br>- Clickable yellow points for each lamp post.</br><br>- Pop-ups displaying information about the lamp posts.</br>",
            greenCircleExplanation: "Green circle: color index of the cluster size.",
            yellowCircleExplanation: "Yellow circle: color index of the cluster size",
            RedCircleExplanation: "Red circle: color index of the cluster size"	,
            yellowPinExplanation: "Yellow pin: location of a streetlight.",
            popupDescription: "Pop-Up: Description of the lighting.",
            bulbQualityFilterLegendHeader: "Bulb Quality Filter Legend",
            bulbQualityFilterDescription: "The bulb quality filter consists of:<br>- Different colored circles based on the bulb quality.</br><br>- Green circles for very good lighting quality.</br><br>- Yellow circles for average lighting quality.</br><br>- Red circles for poor lighting quality.</br><br>- Green circles by default for clusters.</br>",
            greenPinExplanation: "Green pin: location of lighting with good quality.",
            orangePinExplanation: "Orange pin: location of lighting with average quality.",
            redPinExplanation: "Red pin: location of lighting with poor quality.",
            trafficFilterLegendHeader: "Traffic Filter Legend",
            trafficFilterDescription: "The traffic filter consists of:<br>- Different colored lines to indicate the level of road usage.</br><br>- Dark blue lines for low usage.</br><br>- Blue lines for moderate usage.</br><br>- Pink lines for high usage.</br>",
            darkBlueLineExplanation: "Dark blue line: Low traffic.",
            blueLineExplanation: "Blue line: Medium traffic.",
            pinkLineExplanation: "Pink line: High traffic.",
            componentFilterLegendHeader: "Component Filter Legend",
            componentFilterDescription: "The component filter consists of:<br>- A search for lighting based on specific criteria.</br><br>- Display of the individual lighting zone for each streetlight with a light halo.</br><br>- Yellow dots where the streetlights are found based on the criteria.</br><br>- This information helps visualize the light pollution status in certain areas.</br>",
            selectorExplanation: "Selector: text zone to filter lighting.",
            haloExplanation: "Halo: indication of the lighting area of a streetlight.",
            yellowPinExplanation: "Yellow pin: location of lighting after filtering.",
            unknownData: "Unknown Data",
            TotalCost: "Action Costs (in euros):",
            TotalSaving: "Saved within 1 year (in euros):",
            AllOpti: "All optimisations",
            selectActions: "Choisissez une action",
        },
    },
    ...
    fr: {
        translation: {
            ...
            filterLegendHeader: "Légende du filtre Armoire Électrique	",
            filterDescription: "Le filtre des armoires éléctrique ce compose de:<br />- Les armoires électrique noté d'un éclair jaune.<br />- sont cliquables et vous redirige vers le parc de l'armoire électrique.<br />- permettent de comprendre le parc de gestion d'une armoire électrique.",
            yellowLightningExplanation: "Éclair jaune : éclair montrant les armoires électrique.",
            blueLightningExplanation: "Éclair bleu : éclair montrant les armoires électrique en sélection.",
            bluePinExplanation: "Pin bleu : point indiquant les lampadaires lié aux armoires électrique.",
            filter2LegendHeader: "Légende du filtre Trâme noire",
            filter2Description: "Le filtre de la trâme noire ce compose de:<br />- Différentes zones colorées qui ont une sensibilité en lien avec l'écologie.<br />- Les zones sont cliquables et permettent d'afficher des informations sur la zone.",
            popup2Description: "Pop-Up : description de la zone écologique.",
            heatmapLegendHeader: "Légende du filtre Heatmap",
            heatmapDescription: "Le filtre heatmap ce compose de:<br>- Différentes zones avec certains niveaux concentration de la lumière.</br><br>- En bleu quand la zone à un luminosité faible.</br><br>- En vert quand la zone à un luminosité moyenne.</br><br>- En rouge quand la zone à un luminosité forte.</br><br>- Ces informations permettent de voir l'état de la pollution lumineuse sur certaines zones.</br>",
            heatmapCircleExplanation: "heatmap : indice de couleur de la zone.",
            pinFilterLegendHeader: "Légende du filtre par lampadaires	",
            pinFilterDescription: "Le filtre par lampadaire ce compose de:<br>- Clusters qui affiche le nombre de lampadaire par zones en fonction du zoom.</br><br>- De points jaune pour chaque lampadaire à l'endroit exact.</br><br>- De points jaune cliquable pour chaque lampadaire.</br><br>- De pop-up qui affichent des informations sur les lampadaires.</br>",
            greenCircleExplanation: "Cercle vert: indice de couleur de la taille du cluster.",
            yellowCircleExplanation: "Cercle Jaune: indice de couleur de la taille du cluster.",
            RedCircleExplanation: "Cercle rouge: indice de couleur de la taille du cluster.",
            yellowPinExplanation: "Pin jaune: emplacement d'un éclairage.	",
            popupDescription: "Pop-Up : Description de l'éclairage.	",
            bulbQualityFilterLegendHeader: "Légende du filtre Qualité de bulbe",
            bulbQualityFilterDescription: "Le filtre qualité de bulbe ce compose de:<br>- Différents cercles de couleurs en fonction de la qualité du bulbe.</br><br>- Cercles vert pour une très bonne qualité d'éclairage.</br><br>- Cercles jaune pour une moyenne qualité d'éclairage.</br><br>- Cercles rouge pour une mauvaise qualité d'éclairage.</br><br>- Cercles vert par défaut pour les clusters.</br>",
            greenPinExplanation: "Pin vert: emplacement d'un éclairage avec une bonne qualité.",
            orangePinExplanation: "Pin orange: emplacement d'un éclairage avec une moyenne qualité.",
            redPinExplanation: "pin rouge: emplacement d'un éclairage avec une mauvaise qualité.",
            trafficFilterLegendHeader: "Légende du filtre de Traffic",
            trafficFilterDescription: "Le filtre de Traffic est composé de:<br>- Différentes lignes de couleurs pour indiquer le niveau d'utilisation d'une route.</br><br>- De lignes bleu foncé quand peu utilisé.</br><br>- De lignes bleu quand assez utilisé.</br><br>- De lignes rose quand très utilisé.</br>",
            darkBlueLineExplanation: "Ligne bleu foncé: Peu de traffic.",
            blueLineExplanation: "Ligne bleue: Traffic moyen.",
            pinkLineExplanation: "Ligne rose: Traffic fréquent.",
            componentFilterLegendHeader: "Légende du filtre par composant",
            componentFilterDescription: "Le filtre par composant est composé de:<br>- Une recherche d'éclairages en particulier via certains critères.</br><br>- un affichage de la zone d'éclairage individuel de chaque lampadaire avec un halo de lumière.</br><br>- Des points jaune là où les lampadaires sont trouvés en rapport avec les critères.</br><br>- Ces informations permettent de voir l'état de la pollution lumineuse sur certaines zones.</br>",
            selectorExplanation: "Sélecteur: zone de texte pour filtrer l'éclairage.",
            haloExplanation: "Halo: indication de la zone d'éclairage d'un lampadaire.",
            yellowPinExplanation: "Pin jaune: emplacement d'un éclairage après filtrage.",
            unknownData: "Données inconnue",
            TotalCost: "Coûts des actions (en euro):",
            TotalSaving: "Économisé d'ici 1 an (en euro):",
            AllOpti: "Toutes les optimisations"
        },
    },
};
