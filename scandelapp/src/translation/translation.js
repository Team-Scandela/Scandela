...
const resources = {
    ...
    fr: {
        translation: {
            ...
            tuto10: "Cet onglet vous permet de visualiser les évolutions pendant votre absence et leurs impacts sur les indicateurs.",
            tuto20: "La barre de recherche vous permet de rechercher un ville, une rue, une adresse ou bien un lampadaire en particulier.",
            ...
            tuto70: "Ce premier filtre vous permet de visualiser les lampadaires de votre colléctivité, vous pouvez cliquer sur chacun d'entre eux pour obternir plus d'informations et de conseils.",
            ...
            tuto150: "L'aide à la décision vous permet de visualiser et choisir des actions que Scandela aura séléctionnées pour vous grâce à nos algorithmes.",
            tuto160: "La liste des actions vous permet de visualiser les actions que vous aurez préalablement séléctionnées dans l'aide à la décision et d'analyser leurs impact économique et ainsi que sur les indicateurs.",
