...
const resources = {
    ...
    fr: {
        translation: {
            ...
            filterDescription: "Le filtre des armoires éléctrique ce compose de:<br />- Les armoires électrique noté d'un éclair jaune.<br />- sont cliquables et vous redirige vers le parc de l'armoire électrique.<br />- permettent de comprendre le parc de gestion d'une armoire éléectrique.",
